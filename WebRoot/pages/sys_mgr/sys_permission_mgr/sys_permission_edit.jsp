...
<body>
	<form:form id="editForm" name="editForm" method="POST" action="${ctx}/sysPermissionMgr/update" modelAttribute="resultObject">
			...
			<div class="table_div">
				<table width="100%" class="table_border">
					...
					<tr>
						...
						<td>
							<form:select path="status" cssClass="form_input" cssStyle="width:140px">
